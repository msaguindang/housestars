...
<section id="progress-bar" class="header-margin">
	<div class="container">
        ...
        <div class="col-xs-11">
          <p><span class="blue">Subscription Status: {{$status}}</span></p>
          <p>We're unable to charge your account. Please update your payment method below to settle payment and continue your access to our system.</p>
        </div>
      </div>
		</div>
	</div>
...
<section id="sign-up-form">
	<div class="container">
		<div class="row">
			<div class="col-xs-12 form-box no-padding payment" style="margin-top: 0px;">
				...
				<div class="col-xs-6 border-left padding-40">
			        ...
			        <button class="btn hs-primary">UPDATE BILLING <span class="icon icon-arrow-right"></span></button>
			    </form>
				</div>
			</div>
		</div>
