...
var factory = function () {
    ...
    laravel.ajax.init = function () {
        ...
        //Sending form.ajax by AJAX
        $(document).on('submit', 'form.ajax-login', function (event) {
            event.preventDefault();
            $.ajax({
                type: $(this).attr('method'),
                url: $(this).attr('action'),
    ...
    laravel.ajax.errorHandler = function (event) {
        ...
        if (status == 422) {  //validation Error
            ...
            laravel.errors.clearValidation(sender);
            laravel.errors.renderValidation2(payload, sender);
    ...
    laravel.errors.renderValidation2 = function (errors, form) {
        form = form || document;
        //console.info(errors);
