	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 form-box complete">
				...
				<a href="#" class="btn hs-primary" style="padding: 13px; margin-right: 14px;"><span class="icon icon-summary"></span> DOWNLOAD CONTRACT</a><a href="{{env('APP_URL')}}/profile" class="btn hs-primary" style="padding: 13px;"><span class="icon icon-summary"></span> VIEW PROCESSING PAGE</a>
			</div>
		</div>
	</div>
</section>
