      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xs-3 nav-panel">
            ...
            <div class="col-xs-4">
               <label class="switch" style="margin: 0"><input type="checkbox" name="switch" value="1"><div id="switch" class="slider round" style="float: right;"></div></label>
            </div>
          </div>
         ...
         <div class="info-item">
          ...
          <div class="switch-holder">
            ...
            <div class="col-xs-4 switch-guest">
              <label class="switch" style="margin: 0"><input type="checkbox" name="switch" value="0"><div id="switch" class="slider round" style="float: left;"></div></label>
            </div>
          </div>
