<!-- RATE A TRADE OR SERVICES SIGN IN 3-->
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="info-bar" data-toggle="tooltip" data-placement="left" title="This step proves that you are a genuine customer and not a robot. This ensures the ratings data on the site is not false, so you get real information when looking for your next trade or service.">What does this mean?
				</div>
				<a href="/verify/facebook/agency/{{$data['tradesman-id']}}" class="btn social-button hs-facebook"><span class="icon icon-fb-white">Sign in Using Facebook </span> </a>
				</br><p>OR</p>
				<a href="/verify/google/agency/{{$data['tradesman-id']}}" class="btn social-button hs-google-plus"><span class="icon icon-g-white">Sign in Using GOOGLE PLUS</span> </a>
			</div>
		</div>
	</div>
</div> -->
