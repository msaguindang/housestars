...
if($behind[1] == 0) die( $log . 'No new revisions found. Terminating... </div>');
...
if(mail('stuart@simpleclick.com.au, nikko@webforest.solutions, ernest@webforest.solutions ', $subject, $body, $headers))
    $log .= "Email sent.</div>";
else
